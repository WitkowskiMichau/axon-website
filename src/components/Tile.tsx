...
const Tile = ({ title, description, icon }: TileProps) => {
    return (
        <div className="bg-black rounded-lg p-6 w-72 h-56 border-primaryYellow border-2 border-opacity-25 transform transition-transform duration-300 hover:translate-y-[-5px] hover:scale-102 hover:shadow-bright hover:border-shine cursor-pointer">
